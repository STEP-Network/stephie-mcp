...
export async function createLead(params: {
  ...
  const { name, status, status1, status_12, people, email, phone, text, accountId, contactId, opportunitiesId, groupId } = params;
  ...
  if (contactId) columnValues.connect_boards4 = { item_ids: [parseInt(contactId)] };
  if (opportunitiesId) columnValues.connect_boards7 = { item_ids: [parseInt(opportunitiesId)] };
