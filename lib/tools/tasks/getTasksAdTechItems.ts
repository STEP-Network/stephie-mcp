...
export async function getTasksAdTechItems(params: {
  limit?: number;
  search?: string;
  person?: string; // Owner
      ...
      boards(ids: [1635251745]) {
        ...
        items_page(limit: ${limit}${queryParams}) {
          items {
            ...
            created_at
            updated_at
            column_values(ids: ["name", "person", "status_mkkwpmh6", "release_status__1", "priority__1", "date8__1", "date__1", "date5__1", "date7__1", "link_to_teams_Mjj8h8H0"]) {
              id
              text
              value
              column {
