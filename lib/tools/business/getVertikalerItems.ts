...
export async function getVertikalerItems(params: {
  limit?: number;
  search?: string;
  ...
  if (color_mksxpbk5 !== undefined) filters.push({ column_id: 'color_mksxpbk5', compare_value: [color_mksxpbk5], operator: 'any_of' });
