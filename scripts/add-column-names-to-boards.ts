...
const BOARD_ID_TO_TOOL: Record<string, string> = {
  '1402911027': 'getAccountsItems',
  '1549621337': 'getBookingsItems',
  '1939583448': 'getBugsItems',
  '1222800670': 'getChangelogItems',
  '1402911034': 'getContactsItems',
  '1623368485': 'getDealsItems',
  ...
  '1631918659': 'getOKRItems',
  '1402911049': 'getOpportunitiesItems',
  '1741257731': 'getOTTPublishersItems',
  '1663230263': 'getPartnersItems',
  '1612664689': 'getPeopleItems',
  '1611329866': 'getPlatformsItems',
  '1611396339': 'getProcessesItems',
  '1804511159': 'getPublisherFAQItems',
  '1402911042': 'getSalesActivitiesItems',
  '1637264041': 'getStrategiesItems',
  '1717613454': 'getTasksAdOpsItems',
  '1635251745': 'getTasksAdTechItems',
  '1693359113': 'getTasksMarketingItems',
  '1631907569': 'getTasksTechIntelligenceItems',
  '1635510115': 'getTasksVideoItems',
  '1762038452': 'getTasksYieldGrowthItems',
  '1631927696': 'getTeamsItems',
  '2123683129': 'getTestsItems',
  '1647372207': 'getTicketsItems',
  '2054670440': 'getVertikalerItems',
};
...
async function main() {
  ...
  for (const [boardId, itemId] of Object.entries(BOARD_ITEM_MAP)) {
    ...
    console.log(`  Found ${sortedNames.length} columns: ${sortedNames.join(', ')}`);
...
async function getActualItemIds() {
  const query = `
    query {
