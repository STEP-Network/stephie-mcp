...
const mappings = {
	...
	getOpportunities: {
		...
		status4__1:
			"GetAccept template: 0=High Impact, 1=Interstitial, 2=Boligsiden, 107=Pris box",
		...
		formats:
			"Formats (dropdown): 1=Double Midscroll, 2=Midscroll, 3=Midscroll Desktop, 4=Midscroll Mobile, 5=Native, 6=Premium Interstitial, 7=Standard formats, 8=Topscroll, 9=Topscroll Desktop, 10=Topscroll Mobile, 11=Topscroll Expand, 12=Wallpaper, 13=Video - Outstream, 14=Video - Preroll SNVS, 15=Re-Ad",
	},
	// Sales Activities
	getSalesActivities: {
		activity_status:
