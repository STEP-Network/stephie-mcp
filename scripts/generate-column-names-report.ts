...
const BOARD_ID_MAP: Record<string, string> = {
  'getAccountsItems': '1402911027',
  'getBookingsItems': '1549621337',
  'getBugsItems': '1939583448',
  'getChangelogItems': '1222800670',
  'getContactsItems': '1402911034',
  'getDealsItems': '1623368485',
  ...
  'getOKRItems': '1631918659',
  'getOpportunitiesItems': '1402911049',
  'getOTTPublishersItems': '1741257731',
  'getPartnersItems': '1663230263',
  'getPeopleItems': '1612664689',
  'getPlatformsItems': '1611329866',
  'getProcessesItems': '1611396339',
  'getPublisherFAQItems': '1804511159',
  'getSalesActivitiesItems': '1402911042',
  'getStrategiesItems': '1637264041',
  'getTasksAdOpsItems': '1717613454',
  'getTasksAdTechItems': '1635251745',
  'getTasksMarketingItems': '1693359113',
  'getTasksTechIntelligenceItems': '1631907569',
  'getTasksVideoItems': '1635510115',
  'getTasksYieldGrowthItems': '1762038452',
  'getTeamsItems': '1631927696',
  'getTestsItems': '2123683129',
  'getTicketsItems': '1647372207',
  'getVertikalerItems': '2054670440',
};
...
async function generateReport() {
  ...
  const boardReports: Array<{boardName: string, boardId: string, columnNames: string[]}> = [];
  ...
  boardReports.forEach(report => {
    console.log(`${report.boardId},${report.boardName},"${report.columnNames.join('; ')}"`);
  });
  console.log('```');
}
