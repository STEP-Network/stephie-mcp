...
const TOOL_MAPPINGS: Record<string, { path: string; boardId: string }> = {
  ...
  // Sales
  getSalesActivities: { path: 'sales/getSalesActivities.ts', boardId: '1402911042' },
  getOpportunities: { path: 'sales/getOpportunities.ts', boardId: '1402911049' },
  ...
  // Finance
  getMarketingBudgets: { path: 'marketing/getMarketingBudgets.ts', boardId: '1677240056' },
  getMarketingExpenses: { path: 'marketing/getMarketingExpenses.ts', boardId: '1658073379' },
  
  // Tasks
  getTasksTechIntelligence: { path: 'tasks/getTasksTechIntelligence.ts', boardId: '1631907569' },
  getTasksAdOps: { path: 'tasks/getTasksAdOps.ts', boardId: '1717613454' },
  getTasksMarketing: { path: 'tasks/getTasksMarketing.ts', boardId: '1693359113' }
};
