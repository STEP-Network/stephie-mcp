...
const handler = createMcpHandler((server) => {
	...
	// Debug tools
	server.tool("listBoards", getToolDescription("listBoards"), {}, async () => {
	...
	server.tool(
		...
		getToolDescription("getTasksMarketing"),
		{
			...
			channel: z
				...
				.optional()
				.describe(
					"Channel: 0=LinkedIn, 1=Newsletter, 2=PR, 3=Annoncering, 4=Blogindlæg",
				),
		},
		async (input) => {
	...
	server.tool(
		...
		getToolDescription("getTeams"),
		{
			...
			status: z
				.number()
				.describe("Status: 0=Under-Ressourced, 1=Active, 2=Inactive")
				.optional(),
			peopleId: z.string().optional(),
	...
	server.tool(
		...
		getToolDescription("getTickets"),
		{
			...
			priority: z
				.number()
				.optional()
				.describe("Priority: 7=Low, 10=Critical, 109=Medium, 110=High"),
			contactId: z.string().optional(),
			assignedId: z.string().optional(),
	...
	server.tool(
		...
		getToolDescription("createLead"),
		{
			...
			status1: z
				.number()
				.optional()
				.describe("Lead Rating: 0=Hot, 1=Warm, 2=Cold"),
	...
	server.tool(
		...
		getToolDescription("createSalesActivity"),
		{
			...
			dropdown: z
				.number()
				.optional()
				.describe("Activity Type: 0=Email, 1=Phone, 2=Call, 3=Meeting, 7=Note"),
			people: z.string().optional(),
			date: z.string().optional(),
			text: z.string().optional(),
			accountId: z.string().optional(),
	...
	server.tool(
		...
		getToolDescription("createDeal"),
		{
			...
			status5: z
				.number()
				.optional()
				.describe("Deal Type: 0=New Business, 1=Expansion, 2=Renewal"),
			people: z.string().optional(),
			numbers: z.number().optional(),
			date: z.string().optional(),
			accountId: z.string().optional(),
	...
	server.tool(
		...
		getToolDescription("createTicket"),
		{
			...
			priority: z
				.number()
				.optional()
				.describe("Priority: 0=Urgent, 1=High, 2=Medium, 3=Low"),
			people: z.string().optional(),
			email: z.string().optional(),
			text: z.string().optional(),
			long_text: z.string().optional(),
